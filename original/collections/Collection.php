...
use ArrayIterator;
use AutomatedEmails\Original\Abilities\Comparable;
use AutomatedEmails\Original\Abilities\Invokable;
use AutomatedEmails\Original\Characters\StringManager;
use AutomatedEmails\Original\Collections\Abilities\ArrayRepresentation;
use AutomatedEmails\Original\Collections\ArrayGetter;
use AutomatedEmails\Original\Collections\Mapper\Types;
use AutomatedEmails\Original\Collections\Stopper;
...
Class Collection implements IteratorAggregate, ArrayRepresentation, JsonSerializable
{
    ...
    public function reduce(Callable $callback, $initial = '') : StringManager|string|int|float
    {
        /**
    ...
    public function reduceOwn(mixed $initialValue) : mixed
    {
        return $this->reduce(
            fn(mixed $reducedValue, callable $reducer, int|string $key, Stopper $stopper) => $reducer($reducedValue, $key, $stopper), 
            $initialValue
        );
    }
