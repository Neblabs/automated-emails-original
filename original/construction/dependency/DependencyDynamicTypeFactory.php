...
use AutomatedEmails\Original\Dependency\DynamicTypeFromStaticType;

class DependencyDynamicTypeFactory implements OverloadableFactory
{
    /** @param string $value */
    ...
    {
        return new DynamicTypeFromStaticType($type);
    }
}